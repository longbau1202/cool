        ...
        <div class="card">
            <div class="row">
                <div class="col-12">
                    ...
                    @endif
                    <form
                        style="border: 2px dashed #dee2e6; background: #fff; border-radius: 6px; cursor: pointer; min-height: 150px; padding: 20px;"
                        id="addform" name="addform" action="{{ route('maker.store') }}" method="post"
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="makerCode" name="makerCode"
                                        class="form-control @error('makerCode') is-invalid @enderror" placeholder="Enter Code"
                                        value="{{ old('makerCode') }}">
                                </div>
                                @error('makerCode')
